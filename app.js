...
(function () {
  ...
  const icons = {
    ...
    request: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="8" y1="12" x2="16" y2="12"/></svg>`,
  };
  ...
  function buildSidebar() {
    ...
    html += `<div class="nav-separator"></div>`;
    html += `<div class="nav-item${currentView === "requests" ? " active" : ""}" data-view="requests">
      <span class="nav-icon">${icons.request}</span>App Requests
    </div>`;
    html += `<div class="nav-item" data-view="request-new">
      <span class="nav-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg></span>Request an App
    </div>`;
    html += `<div class="nav-separator"></div>`;
